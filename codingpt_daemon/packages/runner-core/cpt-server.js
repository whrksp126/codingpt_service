...
const CAPABILITIES = [
  ...
  'desktop.status', 'desktop.start', 'desktop.provision', 'desktop.connect', 'desktop.disconnect', 'desktop.ax', 'desktop.tap', 'desktop.stop', 'desktop.exec', 'desktop.openApp', 'desktop.openUrl', 'desktop.path',
