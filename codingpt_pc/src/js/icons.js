...
export const icons = {
  ...
  //  왼쪽으로 회전 = 세로 폰(오른쪽) → 가로 폰(왼쪽). 화살표가 도는 방향을 가리킨다.
  rotateLeft: (o) => svg(
    '<rect x="14" y="3.5" width="7" height="11.5" rx="1.6"/>'
    + '<rect x="2.5" y="14" width="11.5" height="7" rx="1.6"/>'
    + '<path d="M12.5 6.2A8.4 8.4 0 0 0 6.2 12.4"/><path d="M4.2 9.6 6 12.7l3.2-1.6"/>', o),
  //  오른쪽으로 회전 = 세로 폰(왼쪽) → 가로 폰(오른쪽).
  rotateRight: (o) => svg(
    '<rect x="3" y="3.5" width="7" height="11.5" rx="1.6"/>'
    + '<rect x="10" y="14" width="11.5" height="7" rx="1.6"/>'
    + '<path d="M11.5 6.2A8.4 8.4 0 0 1 17.8 12.4"/><path d="M19.8 9.6 18 12.7l-3.2-1.6"/>', o),
  volumeUp: (o) => svg(
  ...
  //  기기 전원(화면 켜기/끄기) = 폰 옆면 버튼. 에뮬레이터를 끄는 ⏻ 와 절대 같아 보이면 안 된다.
  devicePower: (o) => svg(
    '<rect x="6.5" y="2.5" width="10" height="19" rx="2.4"/>'
    + '<path d="M18.4 7.5v4" stroke-width="2.4"/>', o),
};
