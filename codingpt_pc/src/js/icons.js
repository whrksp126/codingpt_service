...
const brandSvg = (d, o = {}) =>
  `<svg viewBox="0 0 24 24" width="${(o && o.size) || 16}" height="${(o && o.size) || 16}" fill="currentColor" stroke="none" class="ic ic-brand"><path d="${d}"/></svg>`;
