...
export const icons = {
  ...
  //  ── 모바일 기기 조작 버튼 ────────────────────────────────────────────────
  //  안드로이드 내비게이션 3버튼은 기기 자체의 모양(◁ ○ ▢)을 따른다 — 사용자가 폰에서 늘 보던 것이
  //  가장 빠르게 읽힌다. 글자/이모지 대신 실제 도형으로 그린다.
  ...
  //  회전 — 기기가 도는 것이므로 사각형 + 회살표(새로고침 아이콘과 헷갈리지 않게 사각형을 둔다).
  rotateDevice: (o) => svg('<rect x="8.5" y="3.5" width="7" height="11" rx="1.6"/><path d="M5 15a7 7 0 0 0 12 4.5"/><path d="M17.5 16.5 17 20l-3.4-.6"/>', o),
  volumeUp: (o) => svg('<path d="M4 9.5h3.5L12 6v12l-4.5-3.5H4z"/><path d="M15.5 9.5a3.5 3.5 0 0 1 0 5"/><path d="M18 7a7 7 0 0 1 0 10"/>', o),
  volumeDown: (o) => svg('<path d="M4 9.5h3.5L12 6v12l-4.5-3.5H4z"/><path d="M15.5 9.5a3.5 3.5 0 0 1 0 5"/>', o),
  //  기기 전원(화면 켜기/끄기) — 에뮬레이터 자체를 끄는 오른쪽 끝 버튼과 **모양을 다르게** 둔다.
  devicePower: (o) => svg('<rect x="7" y="2.5" width="10" height="19" rx="2.2"/><line x1="12" y1="7" x2="12" y2="11"/><path d="M9.6 8.2a3.2 3.2 0 1 0 4.8 0"/>', o),
};
