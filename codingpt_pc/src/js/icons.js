...
export const icons = {
  ...
  // 게스트 OS 로고(면 로고 — 라인 아이콘 아님). 에이전트 PC 종류 선택(macOS/Linux)에 쓴다.
  //  브랜드 색을 강요하지 않고 currentColor 로 둔다(메뉴·세그먼트에서 이웃 라인 아이콘과 무게를 맞춘다).
  apple: (o) => brandSvg('M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.22-4.857-.026-3.04 2.48-4.494 2.597-4.559-1.429-2.09-3.623-2.324-4.39-2.376-2-.156-3.675 1.09-4.61 1.09zM15.53 3.83c.843-1.012 1.4-2.427 1.245-3.83-1.207.052-2.662.805-3.532 1.818-.78.896-1.454 2.338-1.273 3.714 1.338.104 2.715-.688 3.559-1.701', o),
  //  Tux — FontAwesome linux(면 로고, 자체 viewBox 448×512). 24-뷰박스 브랜드 래퍼와 달리 뷰박스를 그대로 쓴다.
  linux: (o = {}) => `<svg viewBox="0 0 448 512" width="${o.size || 16}" height="${o.size || 16}" fill="${o.color || "currentColor"}" stroke="none" class="ic ic-brand"><path d="M220.8 123.3c1 .5 1.8 1.7 3 1.7 1.1 0 2.8-.4 2.9-1.5.2-1.4-1.9-2.3-3.2-2.9-1.7-.7-3.9-1-5.5-.1-.4.2-.8.7-.6 1.1.3 1.3 2.3 1 3.4 1.6zm-21.9 1.7c1.2 0 2-1.2 3-1.7 1.1-.6 3.1-.4 3.5-1.6.2-.4-.2-.9-.6-1.1-1.6-.9-3.8-.6-5.5.1-1.3.6-3.4 1.5-3.2 2.9.1 1 1.8 1.5 2.8 1.5zM420 403.8c-3.6-4-5.3-11.6-7.2-19.7-1.8-8.1-3.9-16.8-10.5-22.4-1.3-1.1-2.6-2.1-4-2.9-1.3-.8-2.7-1.5-4.1-2 9.2-27.3 5.6-54.5-3.7-79.1-11.4-30.1-31.3-56.4-46.5-74.4-17.1-21.5-33.7-41.9-33.4-72C311.1 85.4 315.7.1 234.8 0 132.4-.2 158 103.4 156.9 135.2c-1.7 23.4-6.4 41.8-22.5 64.7-18.9 22.5-45.5 58.8-58.1 96.7-6 17.9-8.8 36.1-6.2 53.3-6.5 5.8-11.4 14.7-16.6 20.2-4.2 4.3-10.3 5.9-17 8.3s-14 6-18.5 14.5c-2.1 3.9-2.8 8.1-2.8 12.5 0 3.9.6 7.9 1.2 11.8 1.2 8.1 2.5 15.7.8 20.8-5.2 14.4-5.9 24.4-2.2 31.7 3.8 7.3 11.4 10.5 20.1 12.3 17.3 3.6 40.8 2.7 59.3 12.5 19.8 10.4 39.9 14.1 55.9 10.4 11.6-2.6 21.1-9.6 25.9-20.2 12.5-.1 26.3-5.4 48.3-6.6 14.9-1.2 33.6 5.3 55.1 4.1.6 2.3 1.4 4.6 2.5 6.7v.1c8.3 16.7 23.8 24.3 40.3 23 16.6-1.3 34.1-11 48.3-27.9 13.6-16.4 36-23.2 50.9-32.2 7.4-4.5 13.4-10.1 13.9-18.3.4-8.2-4.4-17.3-15.5-29.7zM223.7 87.3c9.8-22.2 34.2-21.8 44-.4 6.5 14.2 3.6 30.9-4.3 40.4-1.6-.8-5.9-2.6-12.6-4.9 1.1-1.2 3.1-2.7 3.9-4.6 4.8-11.8-.2-27-9.1-27.3-7.3-.5-13.9 10.8-11.8 23-4.1-2-9.4-3.5-13-4.4-1-6.9-.3-14.6 2.9-21.8zM183 75.8c10.1 0 12.1 14.6 12.1 21.9 0 16.4-9.4 22.4-14.7 22.4-8.6 0-13.9-14-14.1-24.7-.1-9.8 5.5-19.6 16.7-19.6zm-27.8 71.9c1.2-3.8 5.5-6.6 7.3-9.1 1.9-2.5 3.3-5.5 3.3-9.6 0-3.9-1.6-6-4.6-6-3.4 0-8.3 3.5-11.3 3.5-3.9 0-8.7-3.5-11.8-3.5-2.4 0-3.4 2.5-4 5.5-.4 2.2-.8 4.5-.8 6.9 0 5.1 2.2 9.9 5.8 12.9 3.6 3 8.3 4.7 13.1 4.7 4.9 0 9.6-1.8 13.2-4.9-1.4-2.6-2.4-5.5-3.2-8.4zm93.8-2.2c-2.3-.7-4.2-.7-5.9-2.3-1.9-1.8-3.5-4.9-5.3-9.4-1.9-4.5-4-8.7-6.7-11.2-2.9-2.7-6.5-3.9-9.8-3.9-3.4 0-6.9 1.2-9.8 3.9-2.7 2.5-4.8 6.7-6.7 11.2-1.8 4.5-3.4 7.6-5.3 9.4-1.7 1.6-3.6 1.6-5.9 2.3-2.3.7-5 1.9-5 4.8 0 .8.2 1.6.6 2.4 1.8 3.6 8.4 5.4 12.9 6.9 6.2 2.1 11.6 4.1 18.1 4.1 6.4 0 11.9-2 18.1-4.1 4.5-1.5 11.1-3.3 12.9-6.9.4-.8.6-1.6.6-2.4 0-2.9-2.7-4.1-5-4.8z"/></svg>`,
