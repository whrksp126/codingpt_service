// 랜딩 — 정적(Static) 렌더. "내 PC를 폰·태블릿에서 원격 조작" 제품 소개 + PC 앱 다운로드.
...
const STEPS = [
  ...
  { t: '어디서든 조작', d: '폰·태블릿에서 내 PC의 터미널·코드 에디터·미리보기를 그대로 열어 작업해요.' },
  { t: '작업 이어가기', d: 'PC에서 하던 일을 폰에서, 다시 태블릿에서 — 같은 워크스페이스가 기기 사이를 따라와요.' },
];

const FEATURES = [
  { t: 'PC 터미널 이어받기', d: '내 컴퓨터의 터미널을 폰에서 그대로 이어서 조작. 실행 중이던 CLI·AI 에이전트 세션도 끊기지 않아요.' },
    ...
    <div>
      ...
      <section style={{ padding: '88px 0 60px' }}>
        ...
        <p className="muted" style={{ fontSize: 18, maxWidth: 620, lineHeight: 1.7, marginTop: 16 }}>
          집이나 사무실의 PC를 <span style={{ color: 'var(--text2)' }}>휴대폰·태블릿에서 그대로</span> 원격 조작하세요.
