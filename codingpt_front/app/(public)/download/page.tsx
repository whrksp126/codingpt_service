...
const STEPS = [
  ...
  { t: '연결', d: '코딩PT 앱에서 [내 정보 → 내 PC 연결]을 열고 페어링 코드를 발급해, 설치한 CodingPT에 입력하면 이 계정에 연결됩니다.' },
  { t: '어디서든', d: '연결되면 폰에서 PC 폴더를 IDE로 열어 편집하고, PC 터미널의 claude 같은 CLI 에이전트를 이어서 조작할 수 있어요.' },
];
