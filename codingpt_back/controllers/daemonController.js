...
async function daemonTerminalStart(req, res) {
  try {
    ...
    const token = daemonRelayService.issueTerminalToken(device.user_id, cwd, paneId, win, client, b.hostDeviceId, b.terminalProtocol, b.deviceName || device.device_name);
...
async function startTerminal(req, res) {
  try {
    ...
    const token = daemonRelayService.issueTerminalToken(userId, cwd, paneId, win, client, req.body && req.body.hostDeviceId, req.body && req.body.terminalProtocol, req.body && req.body.deviceName);
